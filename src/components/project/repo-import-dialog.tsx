...
import { Search, GitBranch, Check, Loader2, ExternalLink } from "lucide-react";
        ...
        {!hasConnections ? (
          <div className="flex flex-col items-center gap-3 py-6 text-center">
            ...
            <p className="text-[var(--text-secondary)]">
              No GitHub accounts connected. Connect one in Settings first.
            </p>
            <Button
              variant="secondary"
              size="sm"
          ...
          <>
            ...
            {selectedConnectionId && !isLoading && repos.length > 0 && (
            ...
            {!isLoading && selectedConnectionId && repos.length === 0 && !error && (
            ...
            {filteredRepos.length > 0 && (
              <ul className="flex max-h-80 flex-col gap-2 overflow-y-auto pr-1">
                {filteredRepos.map((repo, index) => {
                  const alreadyImported = existingRepoUrls.has(repo.htmlUrl);
                      ...
                      >
                        ...
                        {alreadyImported ? (
                          ...
                          <Button
                            ...
                            onClick={() => handleImport(repo, index)}
                          >
                            {isImporting ? (
            ...
            {!isLoading && filteredRepos.length === 0 && repos.length > 0 && search && (
