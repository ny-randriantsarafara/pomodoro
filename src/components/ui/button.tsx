...
const variantStyles = {
    ...
    ghost: 'bg-transparent text-[var(--text-primary)] hover:bg-[var(--border)]/50 focus-visible:ring-[var(--accent)]',
    danger: 'bg-[var(--danger)] text-[#0A0A0B] hover:opacity-90 focus-visible:ring-[var(--danger)]',
} as const;
